...
using AllinaHealth.WebAPI.Areas.HelpPage.ModelDescriptions;
using AllinaHealth.WebAPI.Areas.HelpPage.Models;
using AllinaHealth.WebAPI.Areas.HelpPage.SampleGeneration;

namespace AllinaHealth.WebAPI.Areas.HelpPage
{
    public static class HelpPageConfigurationExtensions
    {
        ...
        private static ModelDescriptionGenerator InitializeModelDescriptionGenerator(HttpConfiguration config)
        {
            ...
            {
                if (TryGetResourceParameter(api, config, out var parameterType))
                {
